...
Aprender en público significa hacerlo con ayuda de todos y no hace falta tener un titulo oficial. ¡Los errores ortográficos vienen al rescate! El perfecto rompehielos para las contribuciones de código abierto, arreglar un error ortográfico es fácil y no requiere de mucha experiencia en GitHub o Git.
